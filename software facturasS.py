import random 
factura1 = round(random.uniform(20, 100))
factura2 = round(random.uniform(20, 100))
factura3 = round(random.uniform(20, 100))
...
seleccion = float(input('Seleccione el número de cliente (1, 2 o 3) para ver detalles de la factura: '))
if seleccion == 1:
